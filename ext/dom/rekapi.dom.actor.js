rekapiModules.push(function (context) {
  ...
  /**
   * This can be useful when used with [CSSRendere#toString](../css-animate/rekapi.css-animate.context.js.html).  You might not ever need to use this directly, as the class is attached to an element when you create a `Rekapi.DOMActor` from said element.
   * @return {string}
   */
